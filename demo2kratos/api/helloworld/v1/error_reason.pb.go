...
const (
	...
	ErrorReason_USER_NOT_FOUND      ErrorReason = 40400
	ErrorReason_GREETER_UNSPECIFIED ErrorReason = 50000
	ErrorReason_TX_ERROR            ErrorReason = 50001
	ErrorReason_DB_ERROR            ErrorReason = 50002
)
...
var (
	ErrorReason_name = map[int32]string{
		0:     "UNKNOWN",
		40400: "USER_NOT_FOUND",
		50000: "GREETER_UNSPECIFIED",
		50001: "TX_ERROR",
		50002: "DB_ERROR",
	}
...
const file_helloworld_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	" helloworld/v1/error_reason.proto\x12\rhelloworld.v1\x1a\x13errors/errors.proto*\x8f\x01\n" +
	"\vErrorReason\x12\x11\n" +
	"\aUNKNOWN\x10\x00\x1a\x04\xa8E\xf4\x03\x12\x1a\n" +
	"\x0eUSER_NOT_FOUND\x10л\x02\x1a\x04\xa8E\x94\x03\x12\x1f\n" +
	"\x13GREETER_UNSPECIFIED\x10І\x03\x1a\x04\xa8E\xf4\x03\x12\x14\n" +
	"\bTX_ERROR\x10ц\x03\x1a\x04\xa8E\xf4\x03\x12\x14\n" +
	"\bDB_ERROR\x10҆\x03\x1a\x04\xa8E\xf4\x03\x1a\x04\xa0E\xf4\x03BE\n" +
	"\rhelloworld.v1P\x01Z demo2kratos/api/helloworld/v1;v1\xa2\x02\x0fAPIHelloworldV1b\x06proto3"
